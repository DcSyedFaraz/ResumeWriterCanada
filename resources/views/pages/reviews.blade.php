@extends('layouts.web')
@section('title','Cheap Resume Writing Services Reviews')
@section('description')
...
@section('content')
    <main>
      <div class="bg-primary py-8">
        <h1 class="text-xl md:text-4xl pb-3 font-medium text-white text-center mx-4 md:mx-0">Reviews showcasing CheapResumeWriter integrity</h1>
        <p class="text-lg md:text-2xl font-medium text-center text-blue-600 mx-4 md:mx-0">We invest in customer's satisfaction and success</p>
        ...
        <p class="text-7xl font-medium pt-8 text-color-secondry text-center">4.9<span class="text-xl ml-2">/5</span> </p>
        ...
        <p class="text-2xl pt-8 text-color-secondry text-center">OVERALL RATING</p>
        ...
        <section class="container mx-auto my-10 px-4">
          ...
          <div class="flex items-center border border-gray-400 rounded-lg border-opacity-60 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-100 hover:border-primary">
              <div class="testimonial p-6 rounded-lg flex hover:bg-gray-100 transition-colors duration-300">
                  ...
                  <div>
                      <p class="">“Glad to know <a class="hover:text-blue-500" href="{{ route('home')}}"> cheapresumewriter.com</a> is offering such quality-driven work at such affordable rates.”</p>
