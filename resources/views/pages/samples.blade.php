...
@section('content')
    ...
    <h4 class="sample-heading " style="font-family: 'Crimson Pro', serif; ">SAMPLE CV / RESUMES</h4>
    <div class="grid  sm:grid-cols-2 lg:grid-cols-4  gap-4 place-items-center mx-5 md:mx-10">
        {{-- <section id="123" > --}}
        <div class="">
            <img  src="{{ asset('imgs/cvsamples/resume-01.jpg') }}" alt="Cheap Cv" id="open-btn-1"
                class=" h-96 hover:translate-y-5 transition duration-300 delay-150  hover:cursor-pointer ">
        </div>
        <div class="">
    ...
    <h4 class="text-[180%] sample-heading" style="font-family: 'Crimson Pro', serif; ">SAMPLE COVER LETTERS</h4>
    ...
    <h4 class="sample-heading" style="font-family: 'Crimson Pro', serif; ">SAMPLE LINKEDIN PROFILES</h4>
    <div class=" grid sm:grid-cols-2 lg:grid-cols-4  gap-2  place-items-center mx-5 md:mx-10 mb-6 ">
        {{-- <section id="123" > --}}
