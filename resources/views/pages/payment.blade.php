                            ...
                            <div class="card text-center">
                                <div class="card-body">
                                    <div class="text-center">
                                        {{-- <img src="{{$source->domain . 'imgs/logo.svg'}}" height="100" alt="{{$source->title}}" title="CV Writings CO UK" loading="lazy" /> --}}
                                    </div>

                                    <div class="grey-line mx-auto"></div>
                                    <span class="t-price d-block">TOTAL PAYABLE</span>
                                    <span class="gbp-text d-block">{{  strtoupper($invoice->currency) . " " . $invoice->amount }}</span>
                                    <span class="choose-text d-block mb-4">Choose Payment Method</span>

                                    <button type="button" class="button-3d" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <h5>
                                            <i class="fa fa-credit-card" aria-hidden="true"></i>
                                            &nbsp; 3D-Secured Payment VIA Debit/Credit Card
                                            <span class="text-end r-text">{{  strtoupper($invoice->currency) . " " . $invoice->amount }}</span>
                                        </h5>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" id="payment-form">
                                <div class="inputWithIcon">
                                    ...
                                    <input type="text" id="email" class="form-control" placeholder="Email Address" value="{{$invoice->user->email ?? ''}}" required>
                                </div>
                                <div class="inputWithIcon">
                                    <i class="fas fa-envelope custom-icon"></i>
                                    <input type="text" id="cardholder-name" class="form-control" placeholder="Card Holder Name" value="{{$invoice->user->name ?? ''}}" required>
                                </div>
                                <div id="card-element"></div>
                                <div id="card-errors" role="alert"></div>
                                <button id="card-button" class="btn btn-success btn-block btn-lg mt-4 w-100 mb-5">{{ "Pay " . $invoice->amount }}  </button>
                            </form>
                        </div>
                    </div>
                </div>
